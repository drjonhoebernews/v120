...
//                self.loadingSign.isHidden = true
            ...
            //3
                func ShareBtnAction(title: String, message: String) {
                    let message1 = message.replacingOccurrences(of: "%20", with: " ", options: .literal, range: nil)
                    let title1 = title.replacingOccurrences(of: "%20", with: " ", options: .literal, range: nil)

                    let objectsToShare = [title1, message1]
                    let activityVC = UIActivityViewController(activityItems: objectsToShare, applicationActivities: nil)
                    activityVC.excludedActivityTypes = [.airDrop, .addToReadingList]

                    activityVC.setValue(title1, forKey: "subject")
            ...
            if requestURL.absoluteString.hasPrefix("shareapp://"){
                ...
                if components.count > 1 {
                   ...
                   title2 = components[1]
                    ...
                    message2 = String(newmeg)
                    title2 = Bundle.main.object(forInfoDictionaryKey: "CFBundleName") as? String ?? ""

                }

                ShareBtnAction(title: title2, message: message2)
